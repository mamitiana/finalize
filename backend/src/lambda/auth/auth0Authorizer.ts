...
const jwksUrl = 'https://dev-9ulmec5z.us.auth0.com/.well-known/jwks.json'
...
async function fetchCertificate(): Promise<string> {
  ...
  if (!signingKeys.length)
    throw new Error('Error JWKS signing keys found')
  ...
  logger.info('Valid certificate: ', cachedCertificate)
